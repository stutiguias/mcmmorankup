...
/**
 *
 * Special Thanks to Alkarin for formula logic and updates...
 * 
* This class is strictly used because Bukkit DOES NOT UPDATE experience after
 * enchanting so using player.getTotalExperience() returns an INCORRECT amount
 * 
 ...
 * 
* The methods and calculations performed in the functions are simplifications
...
public class XpCalc {
     ...
     *
     * @param player
     * @return int Player p's total experience
     */
    ...
    /**
     * Get the total amount of experience to a level within a fractional EXP bar
     *
     * @param level
     * @param bar
     * @return int complete total experience including that of the exp bar
     */
     ...
     *
     * @param level
     * @return int Total Exp needed to get to level
     */
    ...
    /**
     * Get the players current XpLevel
     *
     * @param player
     * @return int xpLevel
     */
    public static int GetPlayerXpl(Player player) {
